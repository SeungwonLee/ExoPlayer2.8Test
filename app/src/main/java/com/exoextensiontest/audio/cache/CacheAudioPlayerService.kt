...
class CacheAudioPlayerService : Service() {
    ...
    override fun onCreate() {
        ...
        val cacheDataSourceFactory =
            CacheDataSourceFactory(DownloadUtils.getCache(this), dataSourceFactory)

        // concat the sources from the network
